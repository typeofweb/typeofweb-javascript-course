describe('Ćwiczenie 11', () => {
  it('1', () => {
    `
    Napisz funkcję "isEmpty", która zwróci informację, czy
    obiekt jest pusty
    `;
    // 👇
    ...
    expect(isEmpty({ [Symbol('test')]: 1 })).toEqual(
      true,
    );
  });
  ...
  it('3', () => {
    `
    Napisz funkcję "countByAge", która zliczy liczbę osób
    o poszczególnym wieku
    `;
    // 👇
    ...
    ).toEqual({ 13: 3, 22: 2, 25: 1 });
  });

  it('4', () => {
    `
    Używając "map" i "reduce" napisz funkcję "mapApiUsers",
    która zamieni podaną tablicę na oczekiany rezultat
    `;
    // 👇
